...
namespace Shaolinq.Persistence
{
		...
		: IDisposable
	{
		...
		public abstract IDataReader ExecuteReader(SqlQueryFormatResult formatResult);
		public abstract Task<IDataReader> ExecuteReaderAsync(SqlQueryFormatResult formatResult);
		public abstract Task<IDataReader> ExecuteReaderAsync(SqlQueryFormatResult formatResult, CancellationToken cancellationToken);
